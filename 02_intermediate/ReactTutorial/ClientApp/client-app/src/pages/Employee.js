...
export class Employee extends Component {
  ...
  changeDepartment = (e) => {
    // this.setState({ DepartmentID: e.target.key });
    this.setState({ DepartmentID: this.state.departments.find(v => v.DepartmentName === e.target.value)['DepartmentID'] });
    // this.state.departments.find(v => v.DepartmentName === e.target.value)['DepartmentID']
  }
                ...
                <div className="d-flex flex-row bd-highlight mb-3">
                  <div className="p-2 w-50 bd-highlight">
                    ...
                    <div className="input-group mb-3">
                      ...
                      <select className="form-select"
                        onChange={this.changeDepartment} value={DepartmentID}
                  ...
                  <div className="p-2 w-50 bd-highlight">
                    <img width="250px" height="250px"
                      src={PhotoPath + PhotoFileName} alt="your photo" />
